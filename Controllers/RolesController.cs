...
namespace SWP_SU4.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        public RolesController(DiamondShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Role>> PostRole(Role role)
        {
            if (role == null)
            {
                return BadRequest("Role musn't be blank");
            }
            if (role.RoleId != null && role.RoleId.ToString().Contains(" "))
            {
                return BadRequest("Role cannot contains space character");
            }
